    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.amazon.client.artifacts.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.amazon.client.artifacts.AWSECommerceService.class.getResource(".");
