 ...
 * generated in the com.pre.unandrun.document.cliet package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://document.upandrun.pre.com/", "getTimeAsElapsed");
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://document.upandrun.pre.com/", "getTimeAsElapsedResponse");
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://document.upandrun.pre.com/", "getTimeAsStringResponse");
    private final static QName _GetTimeAsString_QNAME = new QName("http://document.upandrun.pre.com/", "getTimeAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.pre.unandrun.document.cliet
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.upandrun.pre.com/", name = "getTimeAsElapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.upandrun.pre.com/", name = "getTimeAsElapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.upandrun.pre.com/", name = "getTimeAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.upandrun.pre.com/", name = "getTimeAsString")
